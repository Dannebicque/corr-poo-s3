...
<?php
$auteur1 = new Auteur('Conan Doyle', 'Arthur');
$auteur2 = new Auteur('Conan Doyle', 'Arthur');
$auteur3 = new Auteur('Conan Doyle', 'Arthur');
$auteur4 = new Auteur('Conan Doyle', 'Arthur');


$livre1 = new Livre('Une étude en rouge', new DateTime('1887-11-01'), 240, 'Policier');
$livre1->addAuteur($auteur1, $auteur2, $auteur3);
$livre2 = new Livre('Le manuscrit inachevé', new DateTime('2018-04-11'), 624, 'Thriller');
$livre2->addAuteur(new Auteur('Thilliez', 'Franck'));
